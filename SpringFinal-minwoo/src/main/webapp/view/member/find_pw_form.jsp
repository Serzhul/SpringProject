...
<body>
		...
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" action="${pageContext.request.contextPath}/member/mail_form" method="POST"  autocomplete=”off”>
					...
					<div class="wrap-input100 validate-input" data-validate = "이메일을 입력해 주세요">
						...
						<c:if test="${errors.badEmail }">이메일을 입력하세요</c:if>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "아이디를 입력해 주세요" >
						<input type="text"	class="input100" id="id" name="id" value="${param.id}" required>
							<c:if test="${errors.badId }">아이디를 입력하세요 </c:if>
							<c:if test="${errors.IdAndEmailNo }">존재하지 않는 회원입니다 </c:if>
