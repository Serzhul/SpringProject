...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/view/css/shards.min.css?v=3.0.0">
  <link rel="stylesheet" href="<%=request.getContextPath()%>/view/css/shards-demo.min.css?v=3.0.0">
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      rel="stylesheet">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>

<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/view/carousel/slick/slick.css"/>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/view/carousel/slick/slick-theme.css"/>
<script type="text/javascript" src="//code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/view/carousel/slick/slick.min.js"></script>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success navbar-margin-bottom">
          <img src="<%=request.getContextPath()%>/view/images/demo/shards-logo.svg" alt="Example Navbar 1" class="mr-2 left-margin" height="30">
...
<div class="book-items">
  ...
  <div class="carousel-container" >
  	<img class ="carousel-images" src="<%=request.getContextPath()%>/view/images/carousel/carousel1.jpg">
  </div>
  <div  class="carousel-container" >
  	<img class ="carousel-images" src="<%=request.getContextPath()%>/view/images/carousel/carousel1.jpg">
  </div>
...
<span><a href="<%=request.getContextPath()%>/main/bestseller" /> 클릭!</span>
<div class="rank-list">
<ul class="rank-list-ul">
<c:forEach var="bs" items="${bestseller}">
<li class="rank-list-li">
<div class="rank-list-item">
<div class="rank-list-image"><img src="<%=request.getContextPath()%>/view/images/carousel/${bs.isbn}.jpg" class="rank-list-thumbnail"></div>
</div>
<div class="book-meta-box">
<a href=# class="book-meta-box-rank"> ${bs.rk} </a>
<div class="book-meta-box-books">
<h2 class="book-meta-box-title" style="display:inline">${bs.book_subject} </h2>
