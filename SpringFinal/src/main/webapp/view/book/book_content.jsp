...
#page_detail .detail_scalable_thumbnail .book_thumbnail_wrapper, #page_detail .detail_scalable_thumbnail .thumbnail_wrapper {
    cursor: pointer;
    cursor: zoom-in;
}
...
#page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_cart, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_gift, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_present, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_wish {
    width: 48px;
    font-size: 21px;
    text-align: center;
}
#page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons a, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons button {
    float: left;
    height: 48px;
    line-height: 46px;
    padding: 0;
...
#page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_all_buy, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_all_rent, #page_detail .detail_wrap .detail_body_wrap .detail_body .detail_header .header_info_wrap .info_buttons_wrap .info_buttons .btn_buy {
    padding: 0 16px;
    min-width: 112px;
    font-size: 15px;
}
...
#review_list_section .review_list_wrapper .review_list .list_right .review_status .review_recommend_count .comment_toggle_button, #review_list_section .review_list_wrapper .review_list .list_right .review_status .review_recommend_count .like_button {
    position: relative;
    padding: 6px 10px;
}
...
#review_list_section .review_list_wrapper .review_list .list_left .left_contents .review_date_and_report_wrapper .report_button, #review_list_section .review_list_wrapper .review_list .list_left .left_contents .review_date_and_report_wrapper .review_date {
    color: #808991;
    font-size: 12px;
    line-height: 16px;
}
...
<div class="detail_wrap">
	...
	<article class="detail_header">
				...
				<div class="header_info_wrap">
					...
					${book_content_article.book_subject }
					</div>
					<div class="info_metadata_wrap">
					저자 : ${book_content_article.book_writer }
					</div>
					<div class="info_price_wrap">
					가격 : ${book_content_article.book_price }
					</div>
				...
				<div class="header_thumbnail_wrap">
					...
					<img class="thumbnail" src="<%=request.getContextPath()%>/view/images/carousel/${book_content_article.isbn}.jpg">
				...
				<li class="rui_button_item">
                          <button type="button" class="rui_button_white_50 btn_wish js_add_wishlist trackable">
                            <i class="material-icons nav-subbar-icon">favorite</i>
                          </button>
                        </li>
                 <li class="rui_button_item">
                            <button type="button" class="rui_button_white_50 btn_cart js_add_cart trackable">
                            <i class="material-icons nav-subbar-icon">add_shopping_cart</i>
                            </button>
                          </li>       
				
                <li class="rui_button_item">
                            <a class="rui_button_blue_50 btn_all_buy" href="#">구매하기</a>
                </li>
				...
				<div id="meta_data">출간 일 : ${book_content_article.book_pday } <br/>
					듣기 기능 : ox <br /> 
					</div>
				</div>
		...
		<article id="detail_review" class="detail_box_module detail_review js_detail_review">
		...
		<div class="review_input_wrapper js_review_input_wrapper rate_after">
			...
			<div class="review_textarea_wrapper js_review_textarea_wrapper">
						<textarea id="review_content" name="review_content" class="review_input_textarea js_review_input_textarea"
			...
			<button id="review_submit" name="review_submit" class="rui_button_blue_30 js_review_write_btn write_button disabled">리뷰 등록</button>
					</div>
				</div>
			</div>
			...
			<div class="review_list_wrapper js_review_list_wrapper active">
				...
				<c:forEach var="reviewList" items="${reviewList}">
					<li class="review_list">	
						<div class="list_left js_review_info_wrapper">
							<div class="left_contents">
								<p>
									...
									<c:forEach var="rating" begin="1" end="${ reviewList.rating }">★
									</c:forEach>
									</span>
									<span class="reviewer_id">
										 ${reviewList.id }
									</span>
								</p>
						...
						review_id="${reviewList.id }" review_isbn="${reviewList.isbn}" 
						class ="rui_button_white_25 like_button js_like_button">
						<i class="material-icons nav-subbar-icon">thumb_up</i>
						...
						<i class="material-icons nav-subbar-icon">delete</i>삭제</button>					
