				...
				<div class="summary_box_wrapper js_summary_box_wrapper">
					<div class="summary_box">
						<p class="count_wrapper">
							<span class="icon-check_2"> </span> <span
								class="checked_book_count js_checked_book_count"> </span>권을
							선택하셨습니다.
						...
						<p class="total_price_wrapper">
							<span class="table_wrapper"> <span class="total_text">
									...
									class="js_price_wrapper"> <span
										class="price_num js_price museo_sans"> 10,000 </span>원
				...
				<div class="cart_list_box">
					<div class="module_list_handler js_list_handler_wrapper">
						<div class="total_checkbox">
							<input type="checkbox" id="checkbox_all_top"
								class="rui_checkbox_input js_checkbox_all"
								title="카트에 있는 책 전체 선택"> <label for="checkbox_all_top">전체
								선택</label>
						</div>
