...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/view/js/join.js">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/view/css/join.css">
